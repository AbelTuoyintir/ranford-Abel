...
<body>   
       <div class="bg-gray-100 p-6 rounded-xl">
        <h2 class="text-4xl font-bold text-[#1C204B] my-4">Staff Strong Room</h2>
        <!-- Stats Cards -->
            ...
            <div class="bg-[#1C204B] rounded-xl overflow-hidden shadow-lg transform transition-all duration-300 hover:shadow-xl">
                <div class="p-5">
                    ...
                    <div class="flex items-center justify-between">
                        <h2 class="text-4xl font-bold text-white" id="voter-count-number">0000</h2>
        ...
        <!-- Swiper Container -->
        <div class="swiper relative w-full h-[700px]">
            <div class="swiper-wrapper">
                @foreach($poll->groupBy('portfolio_id') as $portfolioId => $portfolioCandidates)
                    @php
                        $portfolio = \App\Models\portfolios::find($portfolioId);
                    @endphp
                    
                    @if ($portfolio && !$portfolioCandidates->isEmpty())
                        <div class="swiper-slide bg-white rounded-xl shadow-md overflow-hidden" data-election-type="{{ strtolower($portfolio->type) }}">
                            <!-- Portfolio Header -->
                                    ...
                                    @foreach($portfolioCandidates as $candidate)
                                        <div class="transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                                            <div class="bg-white rounded-xl overflow-hidden shadow-md h-full flex flex-col border border-gray-200">
                                                <!-- Candidate Image -->
                                                <div class="relative">
                                                    <img src="{{ asset('storage/' . $candidate->image_path) }}" alt="{{ $poll->candidate->team_name }}" class="h-48 w-full object-cover">
                                                    <!-- Ballot Number Badge -->
                                                ...
                                                <div class="p-4 flex-grow">
                                                    ...
                                                    <div class="mt-auto">
                                                        ...
                                                        <div class="w-full bg-gray-100 rounded-full h-2.5 overflow-hidden">
                                                            <div class="bg-gradient-to-r from-indigo-500 to-indigo-700 h-full rounded-full" style="width: 45%"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
