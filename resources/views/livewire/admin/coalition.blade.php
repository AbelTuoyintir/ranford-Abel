...
<x-admin-sidebar>
    ...
    <div class="container mx-auto my-8 px-4">
        <h1 class="text-3xl font-bold text-center text-gray-100 mb-6">Election App Coalition Table</h1>
            ...
            <table class="min-w-full table-auto" id="logTable">
                <thead class="bg-blue-600 text-white">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-sm font-medium">Male</th>
                        <th class="px-6 py-3 text-left text-sm font-medium">Female</th>
                        <th class="px-6 py-3 text-left text-sm font-medium">Rank</th>
                ...
                <tbody id="logTableBody">
                    ...
                    <tr class="border-t border-gray-100 hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4 text-sm text-green-600"></td>
                        <td class="px-6 py-4 text-sm text-white"></td>
                        <td class="px-6 py-4 text-sm text-white"></td>
                        <td class="px-6 py-4 text-sm text-white"></td>
                        <td class="px-6 py-4 text-sm text-white"></td>
