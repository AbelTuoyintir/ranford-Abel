...
<head>
    ...
    <title>Ucc Election-Admin Login</title>
...
<body>
    <div class="h-screen w-full flex items-center justify-center bg-gray-50">
        ...
        @endif 
            ...
            <!-- Login Form -->
            <form id="loginForm" action="{{ route('login') }}" class="p-6 bg-white rounded-md shadow-xl" method="POST">
                @csrf
                <h1 class="text-lg mb-5 text-[#22296F] text-center font-bold">Admin Panel</h1>
            ...
            {{-- <button class="text-base font-semibold bg-gray-200 rounded-md p-3 mt-5 w-full">
                <a href="{{URL::obfuscated('voter-login')}}">
                    Are you a Voter? Use Voter Panel
                </a>
            </button> --}}
        </div>
    </div>
